...
type PrismaInvoiceResolution = NonNullable<Awaited<ReturnType<typeof prisma.invoiceResolution.findUnique>>>;
...
export class PrismaInvoiceResolutionRepository implements IInvoiceResolutionRepository {
    ...
    async findAllByOrganization(organizationId: string): Promise<InvoiceResolution[]> {
        ...
        return list.map((r: PrismaInvoiceResolution) => this.mapToDomain(r));
    }
