...
import type { InvoiceResolutionProps } from '@chax/shared';

export type { InvoiceResolutionProps } from '@chax/shared';
...
export class InvoiceResolution extends Entity<InvoiceResolutionProps> {
    ...
    public static create(props: InvoiceResolutionProps, id?: string): InvoiceResolution {
        ...
        if (prefix.length === 0) throw new Error('El prefijo es requerido');
        if (prefix.length > 20) throw new Error('El prefijo no puede exceder 20 caracteres');
