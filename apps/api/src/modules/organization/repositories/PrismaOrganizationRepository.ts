...
type PrismaOrganization = NonNullable<Awaited<ReturnType<typeof prisma.organization.findUnique>>>;
...
export class PrismaOrganizationRepository implements IOrganizationRepository {
    ...
    async findAll(): Promise<Organization[]> {
        ...
        return list.map((org: PrismaOrganization) => this.mapToDomain(org));
    }
    ...
    private mapToDomain(prismaOrg: PrismaOrganization): Organization {
        const props: OrganizationProps = {
            ...
            taxRegime: prismaOrg.taxRegime as OrganizationProps['taxRegime'],
