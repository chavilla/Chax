...
export const InvoiceItemTaxRepositoryToken = Symbol.for('IInvoiceItemTaxRepository');
export const DianLogRepositoryToken = Symbol.for('IDianLogRepository');
export const AuditLogRepositoryToken = Symbol.for('IAuditLogRepository');
